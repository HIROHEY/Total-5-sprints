...
func (t Training) distance() float64 {
	...
	arc := float64(t.Action) * t.LenStep / MInKm
	return arc
}
...
func (t Training) TrainingInfo() InfoMessage {
	// вставьте ваш код ниже
	arc := InfoMessage{TrainingType: t.TrainingType, Duration: t.Duration, Distance: t.distance(), Speed: t.meanSpeed(), Calories: t.Calories()}
	return arc
}
...
func (r Running) Calories() float64 {
	...
	ast := ((CaloriesMeanSpeedMultiplier*r.meanSpeed() + CaloriesMeanSpeedShift) * r.Training.Weight / MInKm * r.Duration.Hours() * MinInHours)
	return ast
}
...
func (w Walking) Calories() float64 {
	// вставьте ваш код ниже
	asc := ((CaloriesWeightMultiplier*w.Weight + (math.Pow(w.meanSpeed(), 2)/w.Height)*CaloriesSpeedHeightMultiplier*w.Weight) * w.Duration.Hours() * MinInHours)
	return asc
}
...
func (w Walking) TrainingInfo() InfoMessage {
	// вставьте ваш код ниже
	abc := w.Training.TrainingInfo()
	abc.Calories = w.Calories()
	return abc
}
...
func (s Swimming) TrainingInfo() InfoMessage {
	// вставьте ваш код ниже
	info := InfoMessage{s.Training.TrainingType, s.Training.Duration, s.distance(), s.meanSpeed(), s.Calories()}
	return info
}
